...
def scrape_user_tweets(username, num_tweets=5):
    """
    Scrapes a Twitter user's original tweets (without retweets nor replies).
    :param username: Twitter user
    :param num_tweets: Number of Tweets
    :return: A list of dictionaries. Each containing 3 fields: "time_posted", "text", "url".
    """
